...
Drawdict = {7422: 'VEGFA', 7423: 'VEGFB', 3091: 'HIF1A', 4513: 'COX2', 2260: 'FGFR1', 3480: 'IGF1R',
            5156: 'PDGFRA', 5159: 'PDGFRB', 4851: 'NOTCH1', 1956: 'EGFR', }
...
for gene in Drawlist:
    ...
    figure = plt.figure(figsize=(2, 4), dpi=300)
    ...
    # plt.tight_layout()
    plt.savefig(
        '/Users/freud/Documents/MANU/BI/PANC_ECM/Manuscript/Figure/SubFigure/Comb_angio_' +
        Drawdict[gene] + '_box.tiff', transparent=True)
